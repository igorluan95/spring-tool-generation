...
@RestController   // criando API rest
...
public class CategoriaController		 {
	...
	@Autowired
	private CategoriaRepository repository;                 /// repository é apelido
	...
	public ResponseEntity<List<CategoriaModel>> getByDescricao(@PathVariable String especificacao) {
